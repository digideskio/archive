...
class MakeCollectionsArchives extends Ruckusing_Migration_Base {

  public function up() {
  
  		date_default_timezone_set('UTC');
  
		$this->add_column("collections", "date_created", "datetime", array("null" => false));
		$this->add_column("collections", "date_modified", "timestamp", array("null" => false));
