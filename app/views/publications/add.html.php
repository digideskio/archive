...
<div class="row">
<?=$this->form->create(compact('archive', 'publication', 'link'), array('id' => 'PublicationsForm', 'class' => 'form-horizontal')); ?>
	...
	<div class="span5">
		<div class="well">
			...
			<div class="control-group">
				...
				<div class="controls">
					<?=$this->form->select('archive.classification', $pub_classes_list, array('id' => 'ArchivesClassification')); ?>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<?=$this->form->select('archive.type', $pub_types_list); ?>
				</div>
			</div>
			...
			<?=$this->form->field('archive.earliest_date', array('label' => 'Date', 'autocomplete' => 'off'));?>
			<?=$this->form->field('archive.latest_date', array('label' => 'Latest Date', 'autocomplete' => 'off', 'class' => 'journal'));?>
			...
			<?=$this->form->field('link.url', array('autocomplete' => 'off', 'label' => 'URL', 'placeholder' => 'http://...', 'class' => 'web'));?>
