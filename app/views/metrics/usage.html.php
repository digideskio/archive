...
<div class="row">
	...
	<div class="span3">
		<table class="table table-bordered">
			...
			<caption class="meta"><?=$dates['all_time'] ?> &ndash; <?=$dates['now'] ?></caption>
			<tbody>
				<tr>
					<td class="meta">
						Reporting Period
	...
	<div class="span3">
		<table class="table table-bordered">
			...
			<caption class="meta"><?=$dates['month'] ?> &ndash; <?=$dates['now'] ?></caption>
			<tbody>
				<tr>
					<td class="meta">
						Reporting Period
	...
	<div class="span3">
		<table class="table table-bordered">
			...
			<caption class="meta"><?=$dates['week'] ?> &ndash; <?=$dates['now'] ?></caption>
			<tbody>
				<tr>
					<td class="meta">
						Reporting Period
